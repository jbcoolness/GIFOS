...
const darkModeOn = ()=> {
    ...
    document.getElementById('imgSearchShowMore').classList.add('imgSearchShowMore-noc');
...
const darkModeOff = ()=> {
    ...
    document.getElementById('imgSearchShowMore').classList.remove('searchShowMore-noc')
